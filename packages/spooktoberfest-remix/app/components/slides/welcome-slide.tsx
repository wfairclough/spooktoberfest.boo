...
export function WelcomeSlide({ data }: NodeProps<SlideNode>) {
  return (
    ...
    <Card className="w-full max-w-xl mx-auto bg-orange-100 border-2 border-orange-500 shadow-lg">
      ...
      <CardContent className="text-center space-y-4">
        ...
        <p className="text-lg text-gray-700">
          We've received an amazing selection of spine-chilling movies from all of you. 
          Get ready to cast your votes and decide which films will haunt our screens!
        </p>
      ...
      <CardFooter className="flex justify-center pb-6">
        <Button className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded-full flex items-center gap-2 text-xl">
